...
document.getElementById("header-image").innerHTML = '<img src="./_assets/img/lg_' + currentData.code + '.png" alt="' + currentData.codeName + '" />';
...
if (currentData.add2 === "") {
  document.getElementById("summary-additional").innerHTML = '<a href="./_assets/patch/' + currentData.code + '/' + currentData.add1 + '" class="yellow-link">' + currentData.add1Title + '</a>';
} else {
  document.getElementById("summary-additional").innerHTML = '<a href="./_assets/patch/' + currentData.code + '/' + currentData.add1 + '" class="yellow-link">' + currentData.add1Title + '</a>  |  <a href="./_assets/patch/' + currentData.code + '/' + currentData.add2 + '" class="yellow-link">' + currentData.add2Title + '</a>';
}

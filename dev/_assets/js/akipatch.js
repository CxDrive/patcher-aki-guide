...
if (currentData.add2 === "") {
  document.getElementById("summary-additional").innerHTML = '<a href="' + currentData.add1 + '" class="yellow-link">' + currentData.add1Title + '</a>';
} else {
  document.getElementById("summary-additional").innerHTML = '<a href="' + currentData.add1 + '" class="yellow-link">' + currentData.add1Title + '</a>  |  <a href="' + currentData.add2 + '" class="yellow-link">' + currentData.add2Title + '</a>';
}
document.getElementById("summary-website").innerHTML = '<a href="' + currentData.url + '" class="yellow-link">' + currentData.urlTitle + '</a>';


var propertyFile = currentData.file;

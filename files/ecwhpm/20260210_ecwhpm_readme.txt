ECW: House Party Mixtape: SK Edition
Original release - 12/30/2024
SK edition - 3/3/2024
1.1 Update - 3/9/2024
SK Edition 1.2 - 2/10/2026

by G.M.Spectre and S.K. Stylez

INTRO
-----
So here it is, my total comversion of Wrestlemania 2000 N64 to "ECW Megamix".  I finally added everything I put off from the 0.5 release.  Thanks to S.K.Stylez for creating the WM2000 improvement hack that had a ton of quality of life changes for playing and editing, and a huge save when it came to editing the default names in the rom!
...
- All ring ropes are black
- Fixed default names (THANKS SK!)
- Converted the opening/credit animations
- Rewrote the "Extreme Road Tour"/"Road to Wrestlemania" mode cutscenes
- Slightly tweaked movesets with the SK Styles 1.1 hack additions
- Redid all heights and weights (I actually used a PWI Almanac for this)
- Set in game tag teams
- Set all managers and seconds to wrestlers
- Give managers individual movesets
- "WWF Branded" clothes in CAW taken out and replaced with more generic alternatives
- Fixed Sandman music timing
- Royal Rumble Clock altered
- Masato Tanaka 4th Costume fixed

- Converted the rest of the arenas (Yeah, I know they aren't perfect.  I did what I could.)
	Raw - Hardcore TV
	Heat - ECW on TNN
	KOTR - Hardcore Heaven (Tournament)
	Summerslam - Heatwave
	Survivor Series - November to Remember
	Royal Rumble - House Party
	Wrestlemania - Hostile City Showdown

- Changed entrance weapons
	1 - WWF Mic replaced with Broom
	2 - Guitar replaced with Singapore Cane
	(had to shuffle the models around to the Cane could be Sandman and Credible's specific weapon)
	5 - Godfather Cane replaced with Baseball Bat
	6 - Gangrel Goblet replaced with Chair
	8 - Water Bottle replaced with Table
	9 - Albert Suitcase replaced with Garbage Can
	10- Singapore Cane replaced with Mallet

- In game weapon - Guitar replaced with Singapore Cane 

- Super Finishers Set
	Dreamer - Spicolli Driver
	Douglas - Pittsburgh Plunge
	Taz - Hard Way Tazplex (front)/Tazmission Plex (back)
	Awesome - Awesome Bomb (new move added)
	Tajiri - Strong Kicking
	Mikey 2000 - Poison Mist
...
- Set in game tag teams
	...
	FBI
	- Little Guido + JT Smith
	- Little Guido + Tomy Mamaluke
	- Little Guido + ????? ????????

	HOT COMMODITY
	- Chris Hamrick + Julio Dinero

	DA BALDIES
	- Tony Devito + Spanish Angel

	GANGSTANATORS
	- New Jack + John Kronus

	BWO
	- Stevie Richards + Blue Meanie
	- Stevie Richards + Super Nova
...
CHANGES FOR 1.1 UPDATE
----------------------
- Fixed the game crashing at the title screen because of the extended names
- Opening animation mostly fixed
- Belt graphic for select screen and in match fixed
- All characters have "Normal" or "Often" for their "Weapon Use" stat
- Default CAW costumes slightly edited
- Sandman default weapon set to cane
- Bubba Ray, D-Von and Francine music fixed
- King of the Ring graphics for tournaments taken out

CHANGES FOR 1.2 UPDATE
----------------------
- Uses all changes for SK Styles's WM2000 1.2 patch
- Arena specific Rope colours!
...
- Added 1 new option to Fighting Style - Bloodshed - Never
...
Front Grapples
- Running Awesome Bomb by Krayzie2K99
...
- R-V-D by Krayzie2K99 
- Sabu Point from No Mercy
- Rocco Dance from No MercyTaz
- Arms Up from No Mercy
- Raven Cross from Revenge

Corner Taunt
- House Party Corner by No Mercy
...
In addition to the WM2000 improvement hack and help with names, S.K.Styles made some great spreadsheets that I used to convert various moves and taunts from the other games with their properties intact.  He's also modding the base game of WM2K to get rid of some bugs and make some QOL changed.
...
.....now it's time to get WCW Saturday Night and WWF Wrestlemania X updated to that SK hack!
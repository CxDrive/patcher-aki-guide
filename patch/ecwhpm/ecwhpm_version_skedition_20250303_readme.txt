...
SK edition Released 3/2/2025
Originally released 12/30/2024
Final version
by G.M.Spectre and S.K. Stylez

NOTE - I've found if an emulator is used with the "Emulate Frame Buffer" on in Glide, then the game crashes.  Just click it off in the graphic options, and everything should be good.
...
There may be some minor problems that pop up, but nothing that can't be fixed with a patch later down the line.

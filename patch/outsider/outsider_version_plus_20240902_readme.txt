...
2. Updates from version .98 to Plus
...
- WWF NES - Superstars/Bam Bam/Stand Back/Girls in Cars Medley *+
...
Note that there are more items in preparation for the aforementioned NM Plus v3 Update!
...
- Hack the default spaces in the select screen so a game save file isn't needed (No Mercy Plus v3 will hopefully fix this)
